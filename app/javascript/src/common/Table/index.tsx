        ...
        {rows.map((row, index) => {
          ...
          return (
            <tr
              ...
              onDoubleClick={() => rowOnDoubleClick(row.original.rowId)}
            >
              ...
              {hasRowIcons && (
                <td className="table__cell">
                  <div className="iconWrapper invisible">
                    ...
                    >
                      <PencilIcon className="text-col-han-app-1000" size={16} weight="bold" />
                    </button>}
                    {hasDeleteAction && <button
                      className="ml-10"
                      onClick={e => {
                        e.preventDefault();
                        e.stopPropagation();
                    ...
                    >
                      <DeleteIcon className="text-col-han-app-1000" size={16} weight="bold" />
                    </button>}
                  </div>
                </td>
              )}
