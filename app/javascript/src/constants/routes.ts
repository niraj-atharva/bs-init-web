...
import LeadQuoteDetails from "../components/Leads/QuoteDetails";
...
const ROUTES = [
  ...
  {
    path: Paths.SPACES,
    subRoutes: SpacesRoutes,
    authorisedRoles: [ADMIN, OWNER, EMPLOYEE]
  },
  {
    path: Paths.DEVICES,
    subRoutes: DevicesRoutes,
    authorisedRoles: [ADMIN, OWNER, EMPLOYEE]
  },
  {
    path: Paths.ENGAGEMENTS,
    subRoutes: EngagementRoutes,
    authorisedRoles: [ADMIN, OWNER],
    permissionId: 'engagements'
  },
  {
    path: Paths.LEADS,
    subRoutes: LeadsRoutes,
    authorisedRoles: [ADMIN, OWNER, EMPLOYEE]
  },
  {
    path: Paths.RECRUITMENT,
    subRoutes: RecruitmentRoutes,
    authorisedRoles: [ADMIN, OWNER]
  },
];
